...
#Preview {
    ResultView(viewModel: ResultViewModel(coordinator: Coordinator(), winner: User(name: Resources.Text.secondPlayer, type: .cross, style: .burgerFries), playedAgainstAI: false))
}
