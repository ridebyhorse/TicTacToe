...
#Preview {
    ResultView(viewModel: ResultViewModel(coordinator: Coordinator(), winner: Player(name: Resources.Text.ai, score: 0, symbol: .tic, style: .burgerFries), playedAgainstAI: true))
}
