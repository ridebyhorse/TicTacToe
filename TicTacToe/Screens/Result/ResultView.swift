...
#Preview {
    ResultView(viewModel: ResultViewModel(coordinator: Coordinator(), winner: Player(name: Resources.Text.secondPlayer, symbol: .cross, style: .burgerFries), playedAgainstAI: false))
}
